...
if (isset($_GET['studentId'])) {
	$studentId = str_replace("-", "#", $_GET['studentId']);
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Student Login | NG School</title>
  ...
  <body>
    ...
    <form class="form-signin" action="processes/student_login.process.php" method="POST">
      <div class="text-center mb-4">
       <img class="mb-4 rounded-circle" src="images/stud.png" alt="" width="90" height="75"> 
      ...
      <div class="form-label-group">
      	<?php 
      		if (isset($_GET['studentId'])) {
      			echo'<input type="text" id="inputEmail" class="form-control" name="email" placeholder="Email address" value="'.$studentId.'" required>';
      		}
      		else{
