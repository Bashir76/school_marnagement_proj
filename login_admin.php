...
<html lang="en">
  <head>
    ...
    <meta name="description" content="NG School Login In">
    <meta name="author" content="Bashir Amirkano">
    <link rel="icon" href="../../../../favicon.ico">

    <title>Admin Login | NG School</title>
  ...
  <body>
	...
	<div class="container">
		<form class="form-signin" action="processes/admin_login.process.php" method="POST">
